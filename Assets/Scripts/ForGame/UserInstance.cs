...
#pragma warning disable 649
	...
	public class UserInstance : MonoBehaviourPunCallbacks
	{
		...
		static public UserInstance Instance;
		...
		void Start()
		{
			Instance = this;
				...
				if (PhotonNetwork.InRoom && instance == null)
				{
					...
					instance.AddComponent<FirstPersonMovementNew>();
					GameObject.Instantiate(Resources.Load<GameObject>(CAMERA_RESOURSES_PATH), instance.transform);
			}
				else
				{
